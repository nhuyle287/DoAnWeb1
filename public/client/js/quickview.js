...
$(document).ready(function() {
    $('.list-item').click(function() {
        ...
        $.ajax({
            ...
            // $('#hinhanh1_popup').attr("src", "http://localhost:81/DoAnWeb/public/" + res.hinh_anh1);
            // $('#hinhanh1_figure').attr("style", "background-position: center; background-image: url(\"" + "http://localhost:81/DoAnWeb/public/" + res.hinh_anh1 + "\"); background-repeat: no-repeat; background-size: cover;")
            // $('#hinhanh1_popup1').html("\
            // <img src=\"" + "http://localhost:81/DoAnWeb/public" + "/" + res.hinh_anh1 + "\" alt=\"picture-view\">\
            // ");
            // $('#hinhanh2_popup').html("\
            // <img src=\"" + "http://localhost:81/DoAnWeb/public" + "/" + res.hinh_anh2 + "\" alt=\"picture-view\">\
            // ");

            $('#hinhanh1_popup').attr("src", "http://localhost:81/DoAnWeb1/public/" + res.hinh_anh1);
            $('#hinhanh1_figure').attr("style", "background-position: center; background-image: url(\"" + "http://localhost:81/DoAnWeb1/public/" + res.hinh_anh1 + "\"); background-repeat: no-repeat; background-size: cover;")
            $('#hinhanh1_popup1').html("\
            <img src=\"" + "http://localhost:81/DoAnWeb1/public" + "/" + res.hinh_anh1 + "\" alt=\"picture-view\">\
            ");
            $('#hinhanh2_popup').html("\
            <img src=\"" + "http://localhost:81/DoAnWeb1/public" + "/" + res.hinh_anh2 + "\" alt=\"picture-view\">\
            ");
